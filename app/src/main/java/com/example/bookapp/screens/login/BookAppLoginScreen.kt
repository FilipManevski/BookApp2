...
import com.example.bookapp.components.BookAppTitle
...
@Composable
fun BookAppLoginScreen(navController: NavController,
    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        Column(horizontalAlignment = Alignment.CenterHorizontally,
            ...
            if (showLoginForm.value) UserForm(loading = false, isCreateAccount = false){email, password ->
                viewModel.signInWithWEmailAndPassword(email, password){
...
fun UserForm(
    ...
    Column(modifier, horizontalAlignment = Alignment.CenterHorizontally) {
        if (isCreateAccount) Text(text = stringResource(id = R.string.create_acct_txt),
